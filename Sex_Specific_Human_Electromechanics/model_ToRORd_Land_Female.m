function output=model_ToRORd_Land_Female(t,X,flag_ode, cellType, ICaL_Multiplier, ...
...
cmdnmax= 0.046; 
if celltype==0
    cmdnmax=cmdnmax*1.21;
elseif celltype==1
    cmdnmax=cmdnmax*1.41;
elseif celltype==2
    cmdnmax=cmdnmax*1.21;
end
kmcmdn=0.00238; 
...
Jup=0.94 * (1.0-fJupp)*Jupnp+fJupp*Jupp-Jleak;
